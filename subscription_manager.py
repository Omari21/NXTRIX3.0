...
class SubscriptionManager:
    ...
    def get_tier_comparison(self, show_founder_pricing=False) -> Dict[str, Any]:
        ...
        # Starter: $89/month or $890/year (competitive positioning)
        # Professional: $189/month or $1,890/year (premium voice AI features)  
        # Enterprise: $349/month or $3,490/year (full enterprise features)
